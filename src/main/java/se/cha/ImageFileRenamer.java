...
public class ImageFileRenamer extends JFrame {


    public ImageFileRenamer() throws HeadlessException {
        super("Image file renamer");

        final ImageFileDropPanel dropPanel = new ImageFileDropPanel();

        final FileProcessor fileProcessor = new RenameImageFileProcessor();
    ...
    public static void main(String[] args) {
        final ImageFileRenamer testFrame = new ImageFileRenamer();
