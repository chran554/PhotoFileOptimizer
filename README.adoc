...
The Photo file optimizer process your dropped files in a serial workflow (no parallell processing of several files at the same time), to be able to show a preview of the image in the application window.
