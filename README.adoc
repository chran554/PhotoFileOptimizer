...
[.right]
image::src/main/resources/images/icon-rename.png[rename, 50%]
...
[.right]
image::src/main/resources/images/icon-resave.png[resave, 50%]
...
[.right]
image::src/main/resources/images/icon-resize.png[resize, 50%]
