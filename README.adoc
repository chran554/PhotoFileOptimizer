...
image::src/main/resources/images/icon-rename.png[rename, 50%, float="right"]
...
image::src/main/resources/images/icon-resave.png[resave, 50%, float="right"]
...
image::src/main/resources/images/icon-resize.png[resize, 50%, float="right"]
